...
<body>
    ...
    <header>
      ...
      <div class="container">
       ...
       <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center backGroundPic">
        <div class="col-md-6 p-lg-5 mx-auto mb-5">
          <h1 class="display-3 fw-normal inTextColor">Designed for your future home</h1>
          <h3 class="fw-normal text-muted mb-3">Furniture from Cosmikea</h3>
          <button type="button" class="btn btn-outline-secondary mb-3 ">
            <a class="icon-link text-reset text-decoration-none" href="./cosm_delivery.php">Learn more</a>
          </button>
        </div>
       </div>
       ...
       <div class="px-4 py-5 mt-1 text-center">
        <div class="d-grid gap-2 mb-4 d-sm-flex justify-content-center">
          <svg xmlns="http://www.w3.org/2000/svg" width="45" height="45" fill="#efefef" class="bi bi-arrow-down-circle" viewBox="0 0 16 16">
            <path fill-rule="evenodd" d="M1 8a7 7 0 1 0 14 0A7 7 0 0 0 1 8m15 0A8 8 0 1 1 0 8a8 8 0 0 1 16 0M8.5 4.5a.5.5 0 0 0-1 0v5.793L5.354 8.146a.5.5 0 1 0-.708.708l3 3a.5.5 0 0 0 .708 0l3-3a.5.5 0 0 0-.708-.708L8.5 10.293z"/>
          </svg>
        </div>
        <h1 class="display-5 fw-bold lightText">Interior items that you couldn't dream of</h1>
        <div class="col-lg-6 mx-auto">
          <p class="lead mb-5 lightText" >Quickly design and customize responsive mobile-first sites with Bootstrap, the world’s most popular front-end open source toolkit, featuring Sass variables and mixins, responsive grid system, extensive prebuilt components, and powerful JavaScript plugins.</p>
       ...
       <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-4 cardMargins">
        <div class="col ">
      ...
      <div class="px-4 py-5 my-3 text-center">
        <div class="d-grid gap-2 mb-4 d-sm-flex justify-content-center">
          <svg xmlns="http://www.w3.org/2000/svg" width="45" height="45" fill="#efefef" class="bi bi-eye" viewBox="0 0 16 16">
            <path d="M16 8s-3-5.5-8-5.5S0 8 0 8s3 5.5 8 5.5S16 8 16 8M1.173 8a13.133 13.133 0 0 1 1.66-2.043C4.12 4.668 5.88 3.5 8 3.5c2.12 0 3.879 1.168 5.168 2.457A13.133 13.133 0 0 1 14.828 8c-.058.087-.122.183-.195.288-.335.48-.83 1.12-1.465 1.755C11.879 11.332 10.119 12.5 8 12.5c-2.12 0-3.879-1.168-5.168-2.457A13.134 13.134 0 0 1 1.172 8z"/>
            <path d="M8 5.5a2.5 2.5 0 1 0 0 5 2.5 2.5 0 0 0 0-5M4.5 8a3.5 3.5 0 1 1 7 0 3.5 3.5 0 0 1-7 0"/>
          </svg>
        </div>
        <h1 class="display-5 fw-bold lightText">Want to see more?</h1>
        <div class="col-lg-6 mx-auto">
          ...
          <button type="button" class="btn btn-outline-light mb-3 ">
            <a class="icon-link text-reset text-decoration-none" href="./cosm_allproducts.php">More items</a>
          </button>
