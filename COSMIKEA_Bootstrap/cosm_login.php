...
<div class="container"  >
  ...
  <div class="loginPoster">
      ...
      <form class="mx-auto" action="dtb_login.php" method="post">
        <div class="mb-3">
        ...
        <button type="submit" class="btn btn-light" id="buttoLogin">Enter shop</button>
        <button type="submit" class="btn btn-light" id="buttoRegister"><a class="text-reset text-decoration-none" href="./cosm_signup.php">Create account</a></button>
        </div>
      </form>
