    ...
    <header>
      ...
      <div class="container">
       ...
       <div class="px-4 py-5 mt-1 text-center">
        ...
        <div class="col-lg-6 mx-auto">
          ...
          <div class=" btn-group mb-3 " role="group" aria-label="Basic radio toggle button group">
            <input type="radio" class="btn-check " name="btnRadio" id="btnAll" autocomplete="off" onchange="productSeparator()" checked>
            ...
            <input type="radio" class="btn-check " name="btnRadio" id="btnSofas" autocomplete="off" onchange="productSeparator()" >
       ...
       <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-4 cardMargins allCards">
        <div class="col allFurniture onlyChairs">
        ...
        <div class="col allFurniture onlyTables">
          <div class="card shadow-sm cardBorders">
        ...
        <div class="col allFurniture onlyLamps">
          <div class="card shadow-sm cardBorders">
